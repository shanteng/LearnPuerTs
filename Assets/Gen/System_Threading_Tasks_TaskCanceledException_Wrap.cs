...
#pragma warning disable 0219
    public static class System_Threading_Tasks_TaskCanceledException_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 0)
                {
                    ...
                    {
                        var result = new System.Threading.Tasks.TaskCanceledException();


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(System.Threading.Tasks.TaskCanceledException), result);
                    }
                }
                if (paramLen == 1)
                {
...

                    {
                        ...
                        var result = new System.Threading.Tasks.TaskCanceledException(arg0);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(System.Threading.Tasks.TaskCanceledException), result);
                    }
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Threading.Tasks.Task), false, false, v8Value0, ref argobj0, ref argType0))
                ...
                if (paramLen == 2)
                {
...

                    {
                        ...
                        var result = new System.Threading.Tasks.TaskCanceledException(arg0, arg1);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(System.Threading.Tasks.TaskCanceledException).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== properties start ====================
        ...
        internal static void G_Task(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as System.Threading.Tasks.TaskCanceledException;
                var result = obj.Task;
