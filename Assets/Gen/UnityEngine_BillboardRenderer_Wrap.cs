    ...
    // ==================== properties start ====================
        ...
        internal static void S_billboard(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                object argobj0 = null;
                argobj0 = argobj0 != null ? argobj0 : StaticTranslate<UnityEngine.BillboardAsset>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); UnityEngine.BillboardAsset arg0 = (UnityEngine.BillboardAsset)argobj0;
                obj.billboard = arg0;
            }
            catch (Exception e)
            {
