        ...
        internal static void F_GetAllSubsystemDescriptors(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        
                {
                    ...
                    ;
                    {
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<System.Collections.Generic.List<UnityEngine.ISubsystemDescriptor>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); System.Collections.Generic.List<UnityEngine.ISubsystemDescriptor> arg0 = (System.Collections.Generic.List<UnityEngine.ISubsystemDescriptor>)argobj0;
